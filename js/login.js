        ...
        timerlogin.add([
            {
                ...
                callback(task) {
                    ...
                    document.getElementById("btn-controller").innerHTML = "İyi şanslar";
                    document.getElementsByTagName('title')[0].text = `Mminer - İyi şanslar`
            ...
            },
            {
                ...
                callback(task) {
                    ...
                    if (loginzz.loginauto == true) {
                        document.getElementById("btn-controller").innerHTML = "Sistem girişi Otomatik giriş.. " + Math.ceil(task.totalRuns - task.currentRuns) + " Sec"
                        document.getElementsByTagName('title')[0].text = `Mminer - Başla.. ${Math.ceil(task.totalRuns - task.currentRuns)} Sec`
                    } else {
                        timerlogin.stop();                        
